...
public class NumbersCardTest {
    static NumberCard red_1 = new NumberCard("1", UnoColor.RED, 1);
    static NumberCard red_2 = new NumberCard("2", UnoColor.RED, 2);
    static NumberCard blue_1 = new NumberCard("1", UnoColor.BLUE, 1);
    static NumberCard blue_2 = new NumberCard("2", UnoColor.BLUE, 2);
